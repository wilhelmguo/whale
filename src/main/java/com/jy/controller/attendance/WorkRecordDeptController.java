 ...
 */
@Controller
@RequestMapping("/backstage/WorkRecordDept/")
public class WorkRecordDeptController extends BaseController<WorkRecord> {
  ...
  public String index(Model model) {
    if (doSecurityIntercept(Const.RESOURCES_TYPE_MENU)) {
      ...
      return "/system/attendance/workrecord/department/list";
    }
  ...
  public AjaxRes findByPage(Page<WorkRecord> page, WorkRecord o) {
    ...
    if (ar.setNoAuth(doSecurityIntercept(Const.RESOURCES_TYPE_MENU, "/backstage/WorkRecordDept/index"))) {
      try {
//        o.setEmployee();
        o.setDepartment(AccountShiroUtil.getCurrentUser().getDepartment());
