...
public interface RoleDao extends BaseDao<Role> {
    ...
    public List<ZNodes> getRoleTree(@Param("company") String company);
    ...
    public List<ZNodes> listCompanyAuthorized(@Param("roleId") String roleId, @Param("layer") String layer);

    public List<ZNodes> listPositionAuthorized(@Param("roleId") String roleId);
    /**
     * 根据角色Id删除所有权限关系
     *
     * @param roleId 角色Id
