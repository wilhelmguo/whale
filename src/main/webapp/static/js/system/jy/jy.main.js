...
JY = {
    ...
    Page: {//跳转分页
        ...
        jumpCustom: function (formId, pageId, leng, JpFun) {
            ...
            if (typeof(choseJPage) == "undefined")return; else if (choseJPage == 0)choseJPage = 1; else if (choseJPage > leng)choseJPage = leng;
    ...
    Model: {//loading框
        ...
        confirm: function (Str, fn) {
            ...
            $("#jyConfirm").removeClass('hide').dialog({
                ...
                title_html: true,
                show: {effect: "explode", pieces: 9},
                hide: {effect: "explode", pieces: 9},
                buttons: [{
        ...
        edit: function (id, title, savefn, cancelfn) {
            $("#" + id).removeClass('hide').dialog({
                ...
                buttons: [{
                    ...
                    html: "<i class='icon-remove bigger-110'></i>&nbsp;取消", "class": "btn btn-xs", click: function () {
                        $(this).dialog("close");
        ...
        wideedit: function (width, id, title, savefn, cancelfn) {
            $("#" + id).removeClass('hide').dialog({
                width: width, resizable: true, modal: true,
