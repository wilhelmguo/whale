$(function () {
    JY.Dict.setSelect("selectisValid,selectYear", "year,year", 1, '全部');
    ...
    JY.Ajax.doRequest("baseForm", jypath + '/backstage/workRule/findByPage', null, function (data) {
        ...
        if (results != null && results.length > 0) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                html += "<td class='center hidden-480' >" + JY.Object.notEmpty(l.workDate) + "</td>";
...
function setForm(data) {
    ...
    $("#auForm input[name$='year']").val(JY.Object.notEmpty(l.year));
    $("#auForm input[name$='workDate']").val(JY.Object.notEmpty(l.workDate));
