        ...
        <div class="col-xs-12">
            <form id='leaveFrom' class="form-horizontal" method="POST" onsubmit="return false;">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label no-padding-right"><font color="red">*</font>流程Key</label>
                    <div class="col-sm-2">
                        <select onchange="keyChange()" name="wkey" id="workflowkey" ></select>
                        <%--<input  name="amount" onchange="" value="" jyValidate="required" type="text">--%>
                    </div>
                    <label class="col-sm-2 control-label no-padding-right"><font color="red">*</font>流程名称</label>
                    <div class="col-sm-3">
                        <input name="wname" readonly onchange="" value="" jyValidate="required" type="text">
                    </div>
                </div>
...
<script src="${jypath}/static/js/system/workflow/online/userdef.js"></script>
