        ...
        <div class="col-xs-12">
            ...
            <table id="baseTable" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th style="width:20%" class="center hidden-480">标题</th>
                    <th style="width:10%" class="center">创建时间</th>
                    <th style="width:10%" class="center">流程名称</th>
                    <th style="width:5%" class="center">状态</th>
                    <%--<th style="width:5%" class="center">是否完成</th>--%>
...
<script src="${jypath}/static/js/system/workflow/online/mystart.js"></script>
</body>
</html>