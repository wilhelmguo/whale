    ...
    <ul class="nav ace-nav">
        ...
        <li class="green">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span id="totalNum" class="badge badge-success"></span>
            </a>

            <ul id="msgContent" class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <%--<li>--%>
                    <%--<a href="#">--%>
						<%--<span class="msg-body" style="max-width: 250px">--%>
							<%--<span  class="msg-title">--%>
                                <%--加班流程-李四-2016-08-21 21:23--%>
								<%--<span  class="blue">(已同意)</span>--%>
								...
								<%--<i class="icon-time"></i>--%>
								<%--<span>1分钟以前</span>--%>
                                    <%--&lt;%&ndash;<button style="font-size: 1.0em" class="btn btn-link">标为已读</button>&ndash;%&gt;--%>
								<%--</span>--%>
