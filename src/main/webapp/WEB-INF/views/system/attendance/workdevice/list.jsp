				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:15%" class="center">设备类型</th>
							<th style="width:15%" class="center hidden-480">设备名称</th>
							<th style="width:15%" class="center">所属员工</th>
...
<script src="${jypath}/static/js/system/attendance/workDevice.js"></script>
</body>
</html>