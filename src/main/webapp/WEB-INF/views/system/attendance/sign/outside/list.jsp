    ...
    <div class="page-header">
        <h1>
            ...
            <small><i class="icon-double-angle-right"></i>&nbsp;当前时间:
                ...
                <span  style="color: #c40c6d">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;外勤请到手机端打卡签到</span>
            </small>
        </h1>
    </div>
    <div class="row">
                                            ...
                                            <div class="widget-main">
                                                ...
                                                <div class="widget-toolbox clearfix">
                                                    ...
                                                    <div class="pull-right action-buttons">
                                                        <button style="display: none" id="click1" class="btn btn-sm btn-primary" onclick="insertOrUpdate(1)">打卡</button>
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div class="widget-toolbox clearfix">
                                                    ...
                                                    <div class="pull-right action-buttons">
                                                        <button style="display: none" id="click2" class="btn btn-sm btn-primary" onclick="insertOrUpdate(2)">打卡</button>
                                                        <button onclick="patch(1)" class="btn btn-sm btn-primary">补卡</button>
                                                    </div>
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div class="widget-toolbox clearfix">
                                                    ...
                                                    <div class="pull-right action-buttons">
                                                        <button style="display: none" id="click3" class="btn btn-sm btn-primary" onclick="insertOrUpdate(3)">打卡</button>
                                                        <button onclick="patch(1)" class="btn btn-sm btn-primary">补卡</button>
                                                    </div>
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div class="widget-toolbox clearfix">
                                                    ...
                                                    <div class="pull-right action-buttons">
                                                        <button style="display: none" id="click4" class="btn btn-sm btn-primary" onclick="insertOrUpdate(4)">打卡</button>
                                                        <button onclick="patch(1)" class="btn btn-sm btn-primary">补卡</button>
                                                    </div>
...
<script src="${jypath}/static/js/system/attendance/signOutside.js"></script>
<script>
    function getCurDate() {
        var d = new Date();
        var week;
