				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:7%" class="center">部门</th>
							<th style="width:7%" class="center hidden-480">员工</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>加班开始时间</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>加班结束时间</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>加班时长</th>
...
<script src="${jypath}/static/js/system/attendance/overtime.js"></script>
</body>
</html>