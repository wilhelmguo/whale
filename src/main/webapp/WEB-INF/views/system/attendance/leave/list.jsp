				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:10%" class="center">请假类型</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>请假开始时间</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>请假结束时间</th>
							<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>请假时长</th>
