                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
													<span class="block input-icon input-icon-right"> 
														<input type="text" id="accountNameId" name="accountName"
                                            ...
                                            <label class="block clearfix">
													<span>
														<input class="col-xs-5" id="verifyCodeId" name="verifyCode"
                                                               required="required" maxlength="4" type="tel"
                                                               class="form-control" placeholder="请输入验证码"
                                                               onkeyup="this.value=this.value.replace(/\D/g,'')"/>
													</span>
													<span class="col-sm-5"> 
														<img id="vimg" style="cursor:pointer;width:80px;height:30px;"
                                                             title="验证码" width="60" height="37"/>
													</span>
                                            </label>
                                            <div class="space"></div>
                                            <div class="clearfix">
                                                <span id="selectisValid"><label>请选择公司：</label><select id="companyID"></select></span>
                                                ...
                                                <%--<a href="${jypath}/moblie/index.html">mobile</a>--%>
