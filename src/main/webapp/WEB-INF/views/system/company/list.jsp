				...
				<div class="row">
					<div class="col-sm-3">
						...
						<div class="dataTables_info customBtn">
							<a class="lrspace3" id="authOrgBtn" title="授权公司权限" href="#"><i class="icon-key color-dark-green bigger-240"></i></a>
							<a class="lrspace3" id="addOrgBtn" title="增加公司" href="#"><i class="icon-plus-sign color-green bigger-240"></i></a>
							<a class="lrspace3" id="editOrgBtn" title="修改公司" href="#"><i class="icon-edit color-blue bigger-240"></i></a>
							<a class="lrspace3" id="delOrgBtn" title="删除公司" href="#"><i class="icon-remove-sign color-red bigger-240"></i></a>
						</div>	
					...
					<div class="col-sm-9">	
						...
						<form style="display: none" type="hidden" id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
...
<script src="${jypath}/static/js/system/company/company.js"></script>
</body>
</html>